...
def set_bg_hack_url():
    ...
    st.markdown(
         ...
         <style>
         .stApp {{
             background: url("https://drive.google.com/uc?id=11DlqLGkAOfVWQiyhl760O3NNpUSh-snk");
...
st.write("By Rohit Yadav [GitHub](https://github.com/only-rohit/)")
st.markdown("[Source code](https://github.com/only-rohit/Manga_Recom) | Model from [Scikit-Surprise](https://surprise.readthedocs.io/en/stable/)")
st.text("")
st.text("")

agree = st.checkbox('You are above the age of 18')
